    ...
    <fieldset class="form__container">
      <div class="form__itemContainer">
        ...
        <input
          ...
          :class="{
            form__inputError: $v.surname.$dirty && !$v.surname.required,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive: $v.surname.$dirty && !$v.surname.required,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.surname.$dirty && !$v.surname.minLength,
          }"
          >Поле Фамилия должно иметь больше, чем
          {{ $v.surname.$params.minLength.min }} символа
        </span>
      </div>
      <div class="form__itemContainer">
        ...
        <input
          ...
          :class="{
            form__inputError: $v.firstname.$dirty && !$v.firstname.required,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive: $v.firstname.$dirty && !$v.firstname.required,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.firstname.$dirty && !$v.firstname.alpha,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.firstname.$dirty && !$v.firstname.minLength,
          }"
          >Поле Имя должно иметь больше, чем
          {{ $v.firstname.$params.minLength.min }} символа
        </span>
      </div>
      <div class="form__itemContainer">
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.lastname.$dirty && !$v.lastname.alpha,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.lastname.$dirty && !$v.lastname.minLength,
          }"
          >Поле Отчество должно быть длиной больше, чем
          {{ $v.lastname.$params.minLength.min }} символа
        </span>
      </div>
      <div class="form__itemContainer">
        ...
        <input
          ...
          :class="{
            form__inputError: $v.dateOfBirth.$dirty && !$v.dateOfBirth.required,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive:
              $v.dateOfBirth.$dirty && !$v.dateOfBirth.required,
          }"
      ...
      <div class="form__itemContainer">
        ...
        <span
          ...
          >Поле Номер Телефона должно иметь
          {{ $v.phone.$params.minLength.min }} цифр
        </span>
        <span
          class="form__error"
          ...
          >Поле Номер Телефона должно иметь
          {{ $v.phone.$params.maxLength.max }} цифр
        </span>
      </div>
      <div class="form__itemContainer">
      ...
      <div class="form__itemContainer">
        ...
        <select
          class="form__select form__selectMultiple"
          size="3"
          multiple
          id="clients"
          v-model="selected"
          :class="{
            form__selectMultipleError:
              $v.selected.$dirty && !$v.selected.required,
          }"
        >
        ...
        <span
          class="form__error form__errorSelectMultiple"
          v-if="$v.selected.$dirty && !$v.selected.required"
          :class="{
            form__errorActive: $v.selected.$dirty && !$v.selected.required,
          }"
      ...
      <div class="form__itemContainer form__itemCheckbox">
        <label class="form__label form__labelCheck" for="sms"
          >Не отправлять СМС</label
        >
        <input
          class="form__item form__itemSms"
          type="checkbox"
          id="sms"
          v-model="sms"
        />
    ...
    <fieldset class="form__container">
      ...
      <div class="form__itemContainer">
        ...
        <input
          ...
          :class="{
            form__inputError: $v.postindex.$dirty && !$v.postindex.numeric,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive: $v.postindex.$dirty && !$v.postindex.numeric,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive: $v.postindex.$dirty && !$v.postindex.minLength,
          }"
          >Поле Индекс должно быть длиной в
          {{ $v.postindex.$params.minLength.min }} символов
        </span>
        <span
          class="form__error"
          v-else-if="$v.postindex.$dirty && !$v.postindex.maxLength"
          :class="{
            form__errorActive: $v.postindex.$dirty && !$v.postindex.maxLength,
          }"
          >Поле Индекс должно быть длиной в
          {{ $v.postindex.$params.maxLength.max }} символов
        </span>
      </div>
      <div class="form__itemContainer">
      ...
      <div class="form__itemContainer">
        ...
        <input
          ...
          v-model="houseNumber"
          :class="{
            form__inputError: $v.houseNumber.$dirty && !$v.houseNumber.numeric,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive: $v.houseNumber.$dirty && !$v.houseNumber.numeric,
          }"
    ...
    <fieldset class="form__container">
      ...
      <div class="form__itemContainer">
        ...
        <span
          ...
          :class="{
            form__errorActive:
              $v.typeOfDocument.$dirty && !$v.typeOfDocument.required,
          }"
      ...
      <div class="form__itemContainer">
        ...
        <input
          ...
          :class="{
            form__inputError:
              $v.documentNumber.$dirty &&
              !$v.documentNumber.numeric &&
              !$v.documentNumber.minLength &&
        ...
        <span
          ...
          :class="{
            form__errorActive:
              $v.documentNumber.$dirty && !$v.documentNumber.numeric,
          }"
        ...
        <span
          ...
          :class="{
            form__errorActive:
              $v.documentNumber.$dirty && !$v.documentNumber.minLength,
          }"
          >Поле Номер Документа должно состоять
          {{ $v.documentNumber.$params.minLength.min }} цифр
        </span>
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive:
              $v.documentNumber.$dirty && !$v.documentNumber.maxLength,
          }"
          >Поле Номер Документа должно состоять
          {{ $v.documentNumber.$params.maxLength.max }} цифр
        </span>
      </div>
      <div class="form__itemContainer">
      ...
      <div class="form__itemContainer">
        ...
        <input
          ...
          v-model="dateOfIssue"
          :class="{
            form__inputError: $v.dateOfIssue.$dirty && !$v.dateOfIssue.required,
          }"
        />
        <span
          class="form__error"
          ...
          :class="{
            form__errorActive:
              $v.dateOfIssue.$dirty && !$v.dateOfIssue.required,
          }"
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      this.userCreated = formDataValues.every(
        (item) => item.value !== undefined || item.length !== 0
      );
